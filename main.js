...
underLineButton.addEventListener("click", () =>
  normalText.classList.toggle("underline")
);

// reset button
const resetButton = document.querySelector(".reset");
resetButton.addEventListener("click", () => {
  normalText.classList.remove("bold", "italic", "underline");
...
orangeButton.addEventListener("click", () => {
  ...
  button[1].addEventListener(
    "mouseover",
    () => (button[1].style.backgroundColor = orange)
  );
  button[1].addEventListener(
    "mouseleave",
    () => (button[1].style.backgroundColor = "var(--orange)")
  ...
  button[2].addEventListener(
    "mouseover",
    () => (button[2].style.backgroundColor = orange)
  );
  button[2].addEventListener(
    "mouseleave",
    () => (button[2].style.backgroundColor = "var(--orange)")
